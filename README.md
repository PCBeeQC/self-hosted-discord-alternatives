...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| <img src="https://github.com/PCBeeQC.png?size=48" width="24" height="24" alt="Spokes logo" /> **[Spokes](https://spokes.app/)** | Indie | Paid (2-Month Trial) | 🟢 | Web, PWA | ✅ | 🚧 | ✅ | ✅ | Encrypted | At-Rest | Small / Teams | Flat server fee |
