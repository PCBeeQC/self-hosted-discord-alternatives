...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| <img src="https://github.com/PCBeeQC.png?size=48" width="24" height="24" alt="Spokes logo" /> **[Spokes](https://spokes.sh/)** | Indie | Freemium (Paid Push Relay) | 🟢 | Web, PWA | ✅ | ✅ | ✅ | ✅ | Relay / Encrypted | At-Rest | Small / Teams | Flat server fee |
...
* **Free / Paid:** 
  ...
  * **Freemium:** Core software is free, but certain features (like Enterprise tools or Cloud Relays) require a paid license.
  * **Paid / Licensing:** Software requires a commercial license.
